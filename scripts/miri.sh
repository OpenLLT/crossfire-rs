...
RUSTFLAGS="--cfg tokio_unstable" MIRIFLAGS="-Zmiri-disable-isolation -Zmiri-no-short-fd-operations -Zmiri-backtrace=full" cargo +nightly miri test $@ --features trace_log -- --no-capture --test-threads=1

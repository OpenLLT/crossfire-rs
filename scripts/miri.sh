...
RUSTFLAGS="--cfg tokio_unstable" RUST_BACKTRACE=1 MIRIFLAGS="-Zmiri-disable-isolation -Zmiri-no-short-fd-operations -Zmiri-backtrace=full -Zmiri-permissive-provenance" cargo +nightly miri test $@ -- --no-capture --test-threads=1
